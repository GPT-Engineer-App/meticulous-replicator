...
const GPTEngineer = () => {
  return (
    <div className="flex min-h-screen bg-[#1e2a35] text-white">
      <div className="w-1/2 p-8 flex flex-col justify-between">
        <h1 className="text-2xl font-bold">GPT Engineer</h1>
        <p className="text-lg">Build software products, using only a chat interface</p>
      </div>
      <div className="w-1/2 bg-black p-8 flex items-center justify-center">
        <div className="w-full max-w-md">
          ...
          <p className="text-sm mb-4">Enter your email and password below to login</p>
          ...
          <p className="text-sm text-center">
            Don't have an account? <a href="#" className="text-blue-500 hover:underline">Join the waitlist</a>
          </p>
        </div>
      </div>
    </div>
