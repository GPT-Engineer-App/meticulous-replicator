...
**Project**: meticulous-replicator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Build an exact replicat of this page included as image, make sure you list out all the components sectins by cestion, be meticulous.  
...
```sh
git clone https://github.com/GPT-Engineer-App/meticulous-replicator.git
cd meticulous-replicator
npm i
